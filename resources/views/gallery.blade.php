...
@section('headerContent')
    <div class="cgmi___crousel_container cgmi___crousel_container_about">
        <div>
            <h3 class="text-center">Check the church gallery for pictures</h3>
        </div>
    </div>
@endsection
...
@section('content')
    <section>
        <div class="cgmi___sermon_section">
            <br>
            <h3 class="text-center" style="font-size: 30px; font-weight:bold;text-transform:uppercase">Gallery</h3>
            <br>
